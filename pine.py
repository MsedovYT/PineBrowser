...
plugin = config['User']['Plugins']
if plugin == "True":
    print("WARNING: Plugins are enabled! This is a security risk!")
    print("Please disable plugins in the config.ini file for security.")
    from plugin import Plugin as pl
    pl.plugin("Plugin initialized")
